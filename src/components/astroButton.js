...
class Button extends Component {
  ...
  handleClick = (heart) => {
    ...
    console.log("clicked", this.state.heart)
  }
  ...
  render () {
    ...
    return (
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" fill="none" viewBox="0 0 602 602"  style={viewSvg} preserveAspectRatio="xMidYMid meet" className="like-button">
          <g>
        ...
        <GiAtom style={viewIcon} size={"4em"} color={"#fff"}/>
      </button>
    )
  }
}
